...
const transporter = nodemailer_1.default.createTransport({
    host: env_1.env.googleSMTP_HOST,
    port: env_1.env.SMTP_PORT,
    secure: env_1.env.SMTP_PORT === 465 || env_1.env.SMTP_SECURE,
    auth: {
        user: env_1.env.SMTP_USER,
        pass: env_1.env.SMTP_PASS
    }
});
const SENDER = `"MindVault AI" <${env_1.env.SMTP_USER}>`;
exports.emailService = {
    async sendWorkspaceInviteEmail(toEmail, workspaceName, inviterName, inviteUrl) {
        const htmlContent = `
      <!DOCTYPE html>
      <html>
        <head>
